"""
llama_3_1_instruct_prompter.py

Defines a PromptBuilder for building LLaMa-3 Instruct Prompts

Reference: https://llama.meta.com/docs/model-cards-and-prompt-formats/llama3_1#user-and-assistant-conversation
"""
...
class LLaMa3InstructPromptBuilder(PromptBuilder):
    def __init__(self, model_family: str, system_prompt: Optional[str] = None) -> None:
        ...
        self.wrap_gpt = lambda msg: f"<|start_header_id|>assistant<|end_header_id|>\n\n{msg}<|eot_id|>{self.eos}\n" if msg != '' else f" {self.eos}"
